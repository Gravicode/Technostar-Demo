    ...
    public class MyApplication : MarshalByRefObject, IApplicationLauncher
    {
        ...
        public bool LoadApp(string filename, string[] Dependencies)
        {
            ...
            try
            {
                ...
                {
                    Debug.Print(t[i].BaseType.FullName + ":" + t[i].Name);
            ...
            {
                Debug.Print("Launch Application Error: " + ex.ToString() + "_" + ex.StackTrace);
            }
            ...
            try
            {
                ...
                for (int i = 0; i < t.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        catch (Exception ex) { Debug.Print(ex.Message + "_" + ex.StackTrace);
                        }
                    }
                }
            }
